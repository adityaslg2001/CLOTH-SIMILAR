...
- Had very basic knowledge of Deep Learning, so I spent quality time on learning the new concepts attached to Deep Learning and then began the design-build process of this project.
